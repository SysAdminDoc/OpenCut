...
**Now (priority bumps + new): 20 items**

| F# | Title | Why priority |
|---|---|---|
| F191 | Auto-derive `FeatureRecord` from check functions | 1,300+ routes lack readiness state today |
| F195 | Add 12 missing MCP tools for post-Wave-M shipped routes | 27→39 tool coverage |
| F197 | `NON_AI_CHECKS` allowlist in `registry.py` | Quick hygiene |
| F199 | Document `/api/*` alias policy | 233 dup routes need policy |
...
| F209 | MCP tool ↔ route consistency test | Catch drift |
...
**Next (32 items):** F192, F194, F198, F200, F201, F203, F211, F213, F214, F215, F216, F217, F223, F225, F226, F227, F229, F231, F233, F234, F238, F239, F242, F249, F250, F252, F254, F255, F256, F257, F258, F260. Includes the **F143 conductor + F252 UXP/WebView migration + F225-F229 F105 review-bundle extensions** as parallel flagship tracks.
