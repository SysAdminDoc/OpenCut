# OpenCut Research — CONTINUE FROM HERE (for Pass 55)
...
- **Live counts:** 1,370 routes / 101 blueprints / 528 core modules / 146 test files / 47 model cards / 117 public `check_*` probes (86 `check_*_available`) / 84 `FeatureRecord` entries / 39 curated MCP tools / 1,312 opt-in extended MCP tools / 100 OpenAPI-typed endpoints / 18 CEP host functions (2 CEP-only).
