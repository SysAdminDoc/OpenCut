...
| F252 | UXP migration sequence: Bolt UXP scaffold + WebView UI for 3,210-line HTML | Partially advanced in Pass 59: F252.1 added a dormant `extension/com.opencut.uxp/bolt-webview/` scaffold, least-privilege WebView config template, host API wrappers, bridge files, docs, and guardrail tests. F252 remains open for live WebView cutover and UI migration. | UXP subagent §6 + §10 | XL | Next |
...
| **Next** | [x] F192, [x] F194, [x] F198, [x] F200, [x] F201, [x] F203, [x] F211, [x] F213, [x] F214, [x] F215, [x] F216, [x] F217, [x] F223, [x] F225, [x] F226, [x] F227, [x] F229, [x] F231, [x] F233, [x] F234, [x] F238, [x] F239, [x] F242, [x] F249, [x] F250, F252 (F252.1 done), F254, F255, F256, F257, F258, F260 | 32 |
