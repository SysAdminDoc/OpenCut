...
| [x] F228 | Add voice-note attachments to F105 bundles | Closed in Pass 78 — F105 review bundles now include explicit `voice_notes/index.json` metadata and copied audio attachments with comment/timing/author linkage | Frame.io subagent §2 | S | Later |
...
| [x] F230 | HLS rendition in F105 bundles for browser scrubbing | Closed in Pass 78 — F105 review bundles can opt into `hls/master.m3u8` browser-scrubbing renditions while omitting the full source media | Frame.io subagent §2 | M | Later |
...
| [x] F232 | Optional Headscale path for cross-site LAN review | Closed in Pass 79 — review portal share responses can include a sanitized Headscale/Tailscale operator plan without creating keys or enabling networking from Flask | Frame.io subagent §5 | M | Later |
...
| F252 | UXP migration sequence: Bolt UXP scaffold + WebView UI for 3,210-line HTML | Partially advanced in Passes 59-60 and 83: F252.1 added the dormant Bolt/WebView scaffold, F252.2 added `PProBridge.executeHostAction()` for 14 direct-UXP actions, and F252.3 added strict UDT result-capture validation. F252 remains open for a real in-Premiere UDT capture, live WebView manifest switch, and UI migration. | UXP subagent §6 + §10 | XL | Next |
...
| **Next** | [x] F192, [x] F194, [x] F198, [x] F200, [x] F201, [x] F203, [x] F211, [x] F213, [x] F214, [x] F215, [x] F216, [x] F217, [x] F223, [x] F225, [x] F226, [x] F227, [x] F229, [x] F231, [x] F233, [x] F234, [x] F238, [x] F239, [x] F242, [x] F249, [x] F250, F252 (F252.1/F252.2/F252.3 repository-side slices done), [x] F254, [x] F255, [x] F256, [x] F257, [x] F258, [x] F260 | 32 |
