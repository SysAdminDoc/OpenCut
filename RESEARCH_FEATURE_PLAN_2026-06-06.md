...
4. **P1 -- UXP panel i18n parity** -- foundation loader plus Cut/Captions/FCC display shell slices shipped; broad parity remains open vs CEP's 1,190 attributes
...
- **Current behavior:** CEP panel has 1,190 `data-i18n` attributes and a drift-lint test. UXP now has a local locale loader plus first-viewport, Cut-tab, Captions-tab, and FCC display-settings shell attributes, but most panel strings remain hardcoded English.
...
- **i18n infrastructure:** 1,190 `data-i18n` attributes in CEP, drift-lint test; UXP shell loader shipped in Cycle 94, Cut-tab static coverage shipped in Cycle 95, Captions-tab static coverage shipped in Cycle 96, and FCC display-settings static/dynamic coverage shipped in Cycle 97
- **a11y regression tests:** `test_panel_a11y_invariants.py` guards toast a11y

### Gaps

1. **UXP i18n is only a partial foundation** -- most strings remain hardcoded English (covered in EI-04)
...
- [ ] P1 - **UXP panel i18n infrastructure**
  ...
  - Evidence: CEP has 1,190 `data-i18n` attributes; Cycle 94 added the UXP locale loader and first shell slice, Cycle 95 added Cut-tab coverage, Cycle 96 added Captions-tab coverage, Cycle 97 added FCC display-settings coverage, and broad UXP parity remains below the >500 acceptance target
