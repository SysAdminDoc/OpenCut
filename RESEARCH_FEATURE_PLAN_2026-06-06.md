...
4. **P1 -- UXP panel i18n parity** -- foundation loader plus all-tab static shell, shared runtime, Cut/Captions/Audio/Video/Timeline/Search/Deliverables/Agent/Settings runtime, update/depth-install toast slices, and partial Spanish workspace packaging through Captions shipped; fuller non-English packaging and full parity remain open
...
9. **P2 -- Multi-language locale files** -- partial Spanish UXP pack shipped through Captions workspace coverage; full non-English packs remain open
...
- **Current behavior:** CEP panel has 1,190 `data-i18n` attributes and a drift-lint test. UXP now has a local locale loader plus first-viewport, Cut-tab, Captions-tab, FCC display-settings, Audio-tab, Video-tab, Timeline-tab, Search-tab, Deliverables-tab, Agent-tab, Settings-tab, generated Settings status, shared runtime-toast coverage, Cut runtime-feedback coverage, Captions runtime-feedback coverage, Audio runtime-feedback coverage, Video core/AI-effects/Shorts runtime-feedback coverage, Timeline/Search/Deliverables/Agent/Settings runtime-feedback coverage, and a partial Spanish locale pack with full Cut/Captions/Audio/FCC display/workspace guide/shared runtime/status/Agent/Deliverables/Search/Timeline/Settings plus backend-offline and Deliverables destination-summary coverage plus English fallback merging, but deeper feature-specific dynamic strings and full non-English locale parity remain open.
...
- **i18n infrastructure:** 1,190 `data-i18n` attributes in CEP, drift-lint test; UXP shell loader shipped in Cycle 94, Cut-tab static coverage shipped in Cycle 95, Captions-tab static coverage shipped in Cycle 96, FCC display-settings static/dynamic coverage shipped in Cycle 97, Audio-tab static coverage shipped in Cycle 98, top/core Video-tab static coverage through Depth Effects shipped in Cycle 99, Video effects coverage through Style Transfer shipped in Cycle 100, remaining Shorts/Social Video coverage shipped in Cycle 101, Timeline-tab coverage shipped in Cycle 102, Search-tab coverage shipped in Cycle 103, Deliverables-tab coverage shipped in Cycle 104, Agent-tab coverage shipped in Cycle 105, Settings-tab static/generated-shell coverage shipped in Cycle 106, shared runtime-toast coverage shipped in Cycle 107, Cut runtime-feedback coverage shipped in Cycle 108, Captions runtime-feedback coverage shipped in Cycle 109, Audio runtime-feedback coverage shipped in Cycle 110, Video core runtime-feedback coverage shipped in Cycle 111, Video AI/effects runtime-feedback coverage shipped in Cycle 112, Video Shorts runtime-feedback coverage shipped in Cycle 113, Timeline runtime-feedback coverage shipped in Cycle 114, Search/Deliverables runtime-feedback coverage shipped in Cycle 115, Agent runtime-feedback coverage shipped in Cycle 116, Settings generated/runtime-feedback coverage shipped in Cycle 117, partial Spanish locale packaging shipped in Cycle 118, partial Spanish backend-offline/Settings shell/status coverage shipped in Cycle 119, partial Spanish Cut workspace coverage shipped in Cycle 120, partial Spanish Audio workspace coverage shipped in Cycle 121, partial Spanish FCC display workspace coverage shipped in Cycle 122, partial Spanish workspace guide/shared runtime/status coverage shipped in Cycle 123, partial Spanish full-Settings coverage shipped in Cycle 124, partial Spanish Agent/Deliverables coverage shipped in Cycle 125, partial Spanish Search coverage shipped in Cycle 126, partial Spanish Timeline coverage shipped in Cycle 127, and partial Spanish Captions coverage shipped in Cycle 128
- **a11y regression tests:** `test_panel_a11y_invariants.py` guards toast a11y

### Gaps

1. **UXP i18n is only a partial foundation** -- the main tab static shells, shared runtime toasts, Cut runtime feedback, Captions runtime feedback, Audio runtime feedback, Video core/AI-effects/Shorts runtime feedback, Timeline/Search/Deliverables/Agent/Settings runtime feedback, and partial Spanish locale packaging for first-viewport, Cut, Captions, Audio, FCC display, workspace guide, shared runtime/status, Agent, Deliverables, Search, Timeline, full Settings, and backend-offline coverage now have first-pass coverage, but deeper dynamic surfaces and full non-English locale parity remain open (covered in EI-04)
2. **Only partial non-English locale coverage shipped** -- i18n now has `locales/en.json` plus a partial `locales/es.json` covering first-viewport, Cut, Captions, Audio, FCC display, workspace guide, shared runtime/status, Agent, Deliverables, Search, Timeline, full Settings, and backend-offline surfaces; full translated locale packs remain open
...
- [ ] P1 - **UXP panel i18n infrastructure**
  ...
  - Evidence: CEP has 1,190 `data-i18n` attributes; Cycle 94 added the UXP locale loader and first shell slice, Cycle 95 added Cut-tab coverage, Cycle 96 added Captions-tab coverage, Cycle 97 added FCC display-settings coverage, Cycle 98 added Audio-tab coverage, Cycle 99 added top/core Video-tab coverage through Depth Effects, Cycle 100 added Video effects coverage through Style Transfer, Cycle 101 completed the remaining Video Shorts/Social static shell, Cycle 102 added Timeline-tab static-shell coverage, Cycle 103 added Search-tab static-shell coverage, Cycle 104 added Deliverables-tab static-shell coverage, Cycle 105 added Agent-tab static-shell coverage, Cycle 106 added Settings-tab static/generated-shell coverage, Cycle 107 added shared runtime-toast coverage, Cycle 108 added Cut runtime-feedback coverage, Cycle 109 added Captions runtime-feedback coverage, Cycle 110 added Audio runtime-feedback coverage, Cycle 111 added Video core runtime-feedback coverage, Cycle 112 added Video AI/effects runtime-feedback coverage, Cycle 113 added Video Shorts runtime-feedback coverage, Cycle 114 added Timeline runtime-feedback coverage, Cycle 115 added Search/Deliverables runtime-feedback coverage, Cycle 116 added Agent runtime-feedback coverage, Cycle 117 added Settings generated/runtime-feedback coverage, Cycle 118 added partial Spanish locale packaging, Cycle 119 added partial Spanish backend-offline and Settings shell/status coverage, Cycle 120 added partial Spanish Cut workspace coverage, Cycle 121 added partial Spanish Audio workspace coverage, Cycle 122 added partial Spanish FCC display workspace coverage, Cycle 123 added partial Spanish workspace guide/shared runtime/status coverage, Cycle 124 added full Spanish Settings coverage, Cycle 125 added full Spanish Agent/Deliverables coverage, Cycle 126 added full Spanish Search coverage, Cycle 127 added full Spanish Timeline coverage, Cycle 128 added full Spanish Captions coverage, and broad UXP parity has crossed the >660 static-attribute target while remaining short of full locale parity
  - Touches: `extension/com.opencut.uxp/main.js`, `index.html`, `locales/en.json`, `locales/es.json`, `tests/test_uxp_i18n.py`
  - Acceptance: UXP loads `locales/en.json`, merges partial non-English packs over English fallback strings, and keeps `data-i18n` count > 660
