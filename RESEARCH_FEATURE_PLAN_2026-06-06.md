...
- **Current behavior:** CEP panel has 1,190 `data-i18n` attributes and a drift-lint test. UXP now has a local locale loader plus first-viewport, Cut-tab, Captions-tab, FCC display-settings, Audio-tab, Video-tab, Timeline-tab, Search-tab, Deliverables-tab, Agent-tab, Settings-tab, generated Settings status, shared runtime-toast coverage, Cut runtime-feedback coverage, Captions runtime-feedback coverage, Audio runtime-feedback coverage, Video core/AI-effects/Shorts runtime-feedback coverage, Timeline/Search/Deliverables/Agent/Settings runtime-feedback coverage, and a partial Spanish locale pack with full Cut/Audio/FCC display/workspace guide/shared runtime/status/Agent/Deliverables/Settings plus backend-offline and Deliverables destination-summary coverage plus English fallback merging, but deeper feature-specific dynamic strings and full non-English locale parity remain open.
