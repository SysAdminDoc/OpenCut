...
4. **P1 -- UXP panel i18n parity** -- foundation loader plus Cut/Captions/FCC display/Audio/Video static-shell slices shipped; broad parity remains open vs CEP's 1,190 attributes
...
- **Current behavior:** CEP panel has 1,190 `data-i18n` attributes and a drift-lint test. UXP now has a local locale loader plus first-viewport, Cut-tab, Captions-tab, FCC display-settings, Audio-tab, and Video-tab static-shell attributes, but most other panel strings remain hardcoded English.
