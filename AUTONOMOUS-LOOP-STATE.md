...
- Verification: `py -3.12 scripts\i18n_lint.py --json` (2,457 keys, 2,457 unique consumers, 0 dead, 0 missing); `py -3.12 -m pytest -q tests\test_i18n_hardcoded_migration.py tests\test_i18n_drift.py tests\test_generative_routes_security.py` (16 passed, 3,998 subtests passed); `py -3.12 -m ruff check opencut\routes\generative_routes.py tests\test_generative_routes_security.py tests\test_i18n_hardcoded_migration.py scripts\i18n_lint.py`; `py -3.12 scripts\sync_badges.py --check`; `py -3.12 scripts\check_doc_sizes.py --check`; `py -3.12 -m pytest -q tests\test_roadmap_mirror.py tests\test_roadmap_lint.py` (15 passed); `git diff --check`; `py -3.12 scripts\release_smoke.py --only ruff --json`; `py -3.12 scripts\release_smoke.py --only pytest-fast --json` (101 gate tests, 840 passed).
