...
- Verification: `py -3.12 -m pytest -q tests\test_helpers_cleanup.py tests\test_request_correlation_subprocess.py tests\test_config_and_userdata.py::test_runtime_boot_modules_avoid_pep604_annotations_for_python39` (7 passed); `py -3.12 -m ruff check opencut\helpers.py tests\test_helpers_cleanup.py`; `py -3.12 scripts\sync_badges.py --check`; `py -3.12 scripts\check_doc_sizes.py --check`; `py -3.12 -m pytest -q tests\test_roadmap_mirror.py tests\test_roadmap_lint.py` (15 passed); `git diff --check`; `py -3.12 scripts\release_smoke.py --only ruff --json`; `py -3.12 scripts\release_smoke.py --only pytest-fast --json` (102 gate tests / 842 passed).
