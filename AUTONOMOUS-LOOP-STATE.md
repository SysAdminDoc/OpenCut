...
- Verification: `py -3.12 -m pytest -q tests\test_motion_design.py::TestExpressionEngine tests\test_batch_data.py::TestExpressionEngine` (60 passed); `py -3.12 -m ruff check opencut\core\expression_engine.py tests\test_motion_design.py tests\test_i18n_hardcoded_migration.py tests\test_i18n_drift.py scripts\i18n_lint.py`; 30-second local timeline benchmark (900 frames, 0 errors, `threading.enumerate()` stayed at 2 before and after); `py -3.12 -m json.tool extension\com.opencut.panel\client\locales\en.json`; `py -3.12 scripts\i18n_lint.py --json` (2,515 keys, 2,515 consumers, 0 dead, 0 missing); `py -3.12 -m pytest -q tests\test_i18n_hardcoded_migration.py tests\test_i18n_drift.py` (14 passed, 4,120 subtests passed); `py -3.12 scripts\release_smoke.py --only ruff --json`; `py -3.12 scripts\release_smoke.py --only pytest-fast --json` (101 gate tests / 840 passed).
