...
Last synced: 2026-06-06 during the RA-41 render-cache and temp-cleanup confirmation pass.
...
- [ ] **RA-41 destructive-operation plan contract** - shared dry-run/confirmation-token helpers now protect queue/log/caption-cache/Whisper-cache/model-cache/render-cache/temp-cleanup clears; continue the contract across plugin quarantine permanent delete, user-data tombstone-backed deletes, and remaining destructive endpoints.
