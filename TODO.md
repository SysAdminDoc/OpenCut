...
Last synced: 2026-06-06 during the CEP i18n duplicate dead-key cleanup pass.

## Execution Order

- [ ] **E15 i18n migration rolling batches** - current detailed state: v4.273 / batch 161. Continue removing high-impact bare-English CEP panel strings and dead keys in guarded batches.
