...
- [x] **UXP i18n foundation slice** - UXP now loads a local `locales/en.json`, applies text/title/placeholder/aria locale attributes, localizes 178 shell/workspace/Cut/Captions hooks, and carries a release-smoke static guard for UXP locale coverage.
