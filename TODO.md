...
Last synced: 2026-06-06 during the CEP i18n settings/form cleanup pass.

## Execution Order

- [ ] **E15 i18n migration rolling batches** - current detailed state: v4.274 / batch 162. Continue removing high-impact bare-English CEP panel strings and dead keys in guarded batches.
