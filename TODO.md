...
Last synced: 2026-06-06 during the RA-41 adjacent state-clear confirmation pass.
...
- [ ] **RA-41 destructive-operation plan contract** - shared dry-run/confirmation-token helpers now protect the original named queue/log/cache/model/plugin/user-data destructive endpoints plus adjacent assistant/chat/undo/search state clears; continue with worker-pool cleanup and any remaining clear/cleanup routes.
