...
Last synced: 2026-06-06 during the CEP i18n final dead-key cleanup pass.

## Execution Order

- [ ] **E15 i18n migration rolling batches** - current detailed state: v4.276 / batch 164 with a zero-dead-key baseline. Continue removing high-impact bare-English CEP panel strings and expanding scanner coverage in guarded batches.
