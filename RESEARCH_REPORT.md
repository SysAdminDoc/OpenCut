...
route escape hatch are now represented as shipped in the live v4.185 docs; E15
also has its fourth through eighty-seventh rolling i18n batches recorded there, and `TODO.md`
...
rolling in v4.185; the strongest remaining direction is **not** another wave of
...
- **Git range:** `git log -30 --oneline`; 39 commits since 2026-05-20 at the
  ...
  through v4.100, E15 has v4.101-v4.185 rolling batches, and the earlier checkpoints include `b228e42`, `ae25c96`,
