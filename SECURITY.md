...
OpenCut ships rapidly. We actively support the **latest minor** (`1.47.x`) and the one immediately preceding it (`1.46.x`). Older minors receive security-only backports for 90 days after they're superseded.

| Version | Supported         | Security fixes until |
|---------|-------------------|----------------------|
| 1.47.x  | ✅ Active         | —                    |
| 1.46.x  | ✅ Previous       | +90 days after 1.47  |
| 1.45.x  | ⚠️ Critical only | +30 days after 1.47 |
| ≤ 1.44  | ❌ End of life   | n/a                  |
