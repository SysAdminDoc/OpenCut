...
STYLES: Dict[str, CaptionStyle] = {
    ...
    "neon_glow": CaptionStyle(
        ...
        action_color=(255, 255, 0, 255),
        stroke_color=(0, 80, 60, 255),
        stroke_width=3,
        shadow_color=(0, 255, 200, 100),
        shadow_offset=(0, 0),
        margin_bottom=80,
        preview_css="font-family:'Arial Black',Arial,sans-serif;color:#00ffc8;-webkit-text-stroke:2px #00503c;text-shadow:0 0 12px rgba(0,255,200,0.6),0 0 30px rgba(0,255,200,0.3)",
    ),
    "slide_up": CaptionStyle(
        name="slide_up",
        label="Slide Up",
        font_name="Arial Bold",
        font_file="arialbd.ttf",
        ...
        bg_radius=8,
        margin_bottom=60,
        preview_css="font-family:Arial,Helvetica,sans-serif;font-weight:700;color:#fff;background:rgba(0,0,0,0.7);padding:5px 12px;border-radius:6px",
    ),
    "word_pop": CaptionStyle(
        ...
        font_size=68,
        text_color=(255, 255, 255, 255),
        highlight_color=(255, 60, 120, 255),
        action_color=(60, 255, 160, 255),
        stroke_color=(0, 0, 0, 255),
        stroke_width=5,
        margin_bottom=90,
        preview_css="font-family:Impact,sans-serif;color:#fff;-webkit-text-stroke:3px #000;text-shadow:4px 4px 0 #000;font-size:1.3em;text-transform:uppercase",
    ),
    "emoji_react": CaptionStyle(
        name="emoji_react",
        label="Emoji React",
        font_name="Arial Black",
        font_file="ariblk.ttf",
        ...
        bg_radius=14,
        margin_bottom=80,
        preview_css="font-family:'Arial Black',Arial,sans-serif;color:#fff;-webkit-text-stroke:2px #000;background:rgba(30,30,40,0.8);padding:5px 14px;border-radius:10px",
    ),
    "speaker_colored": CaptionStyle(
        name="speaker_colored",
        label="Speaker Colored",
        font_name="Arial Bold",
        font_file="arialbd.ttf",
        font_size=48,
        text_color=(200, 220, 255, 255),
        highlight_color=(100, 180, 255, 255),
        action_color=(255, 150, 100, 255),
        ...
        margin_bottom=50,
        line_spacing=1.35,
        preview_css="font-family:Arial,Helvetica,sans-serif;font-weight:700;color:#c8dcff;background:rgba(10,10,20,0.7);padding:4px 12px;border-radius:5px;border-left:3px solid #64b4ff",
    ),
    "retro_vhs": CaptionStyle(
        name="retro_vhs",
        label="Retro VHS",
        font_name="Courier New",
        font_file="cour.ttf",
        ...
        margin_bottom=40,
        line_spacing=1.3,
        preview_css="font-family:'Courier New',Courier,monospace;color:rgba(255,255,255,0.94);background:rgba(0,0,0,0.78);padding:4px 10px;text-transform:uppercase;letter-spacing:2px;font-size:0.8em",
    ),
    "podcast": CaptionStyle(
        ...
        font_file="georgia.ttf",
        font_size=46,
        text_color=(240, 240, 235, 255),
        highlight_color=(120, 200, 160, 255),
        action_color=(255, 180, 80, 255),
        stroke_color=(0, 0, 0, 0),
        stroke_width=0,
        bg_color=(25, 30, 35, 200),
        bg_padding=(24, 14),
        bg_radius=10,
        margin_bottom=60,
        max_width_pct=0.88,
        line_spacing=1.4,
        preview_css="font-family:Georgia,'Times New Roman',serif;color:#f0f0eb;background:rgba(25,30,35,0.78);padding:6px 16px;border-radius:8px;font-size:0.9em",
    ),
    "gaming": CaptionStyle(
        name="gaming",
        label="Gaming",
        ...
        action_color=(255, 0, 0, 255),
        stroke_color=(0, 0, 0, 255),
        stroke_width=4,
        shadow_color=(0, 255, 0, 60),
        shadow_offset=(0, 0),
        margin_bottom=80,
        preview_css="font-family:Impact,sans-serif;color:#fff;-webkit-text-stroke:3px #000;text-shadow:0 0 8px rgba(0,255,0,0.4);text-transform:uppercase;letter-spacing:2px",
    ),
    "luxury": CaptionStyle(
        name="luxury",
        label="Luxury",
        ...
        font_file="georgia.ttf",
        font_size=44,
        text_color=(220, 200, 160, 255),
        highlight_color=(255, 215, 0, 255),
        action_color=(200, 180, 140, 255),
        stroke_color=(0, 0, 0, 0),
        stroke_width=0,
        ...
        line_spacing=1.5,
        max_width_pct=0.75,
        preview_css="font-family:Georgia,'Times New Roman',serif;color:#dcc8a0;text-shadow:2px 2px 6px rgba(0,0,0,0.6);letter-spacing:2px;font-size:0.9em",
    ),
    "tiktok_bold": CaptionStyle(
        ...
        font_size=64,
        text_color=(255, 255, 255, 255),
        highlight_color=(254, 44, 85, 255),
        action_color=(37, 244, 238, 255),
        stroke_color=(0, 0, 0, 255),
        stroke_width=4,
        margin_bottom=100,
        max_width_pct=0.80,
        preview_css="font-family:'Arial Black',Arial,sans-serif;color:#fff;-webkit-text-stroke:3px #000;text-shadow:3px 3px 0 #000;text-transform:uppercase;letter-spacing:1px",
    ),
    "handwritten": CaptionStyle(
        name="handwritten",
        label="Handwritten",
        font_name="Comic Sans MS",
        font_file="comic.ttf",
        font_size=48,
        text_color=(60, 60, 50, 255),
        highlight_color=(200, 80, 80, 255),
        action_color=(80, 120, 200, 255),
        stroke_color=(0, 0, 0, 0),
        stroke_width=0,
        bg_color=(255, 250, 230, 230),
        bg_padding=(22, 12),
        bg_radius=4,
        margin_bottom=60,
        line_spacing=1.4,
        preview_css="font-family:'Comic Sans MS',cursive,sans-serif;color:#3c3c32;background:rgba(255,250,230,0.9);padding:6px 14px;border-radius:3px;transform:rotate(-1deg)",
    ),
    "rtl_arabic": CaptionStyle(
        name="rtl_arabic",
        label="RTL Arabic",
        font_name="Tahoma",
        ...
        font_size=50,
        text_color=(255, 255, 255, 255),
        highlight_color=(50, 200, 150, 255),
        action_color=(255, 150, 50, 255),
        stroke_color=(0, 0, 0, 220),
        stroke_width=2,
        bg_color=(0, 0, 0, 160),
        bg_padding=(20, 10),
        ...
        margin_bottom=70,
        max_width_pct=0.88,
        preview_css="font-family:Tahoma,'Noto Sans Arabic',sans-serif;color:#fff;background:rgba(0,0,0,0.6);padding:5px 14px;border-radius:6px;direction:rtl;text-align:right",
    ),
}
