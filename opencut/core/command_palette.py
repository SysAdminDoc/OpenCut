...
_FEATURE_DEFS: List[dict] = [
    ...
    # F354: route-family entry points for the largest integration-only groups.
    {"id": "wave_l_omni_info", "name": "Omni Video Analysis Info", "description": "Inspect the Omni video analysis lane", "category": "analysis", "aliases": ["omni", "video analysis", "wave l"], "route": "/analyze/video/omni/info", "tags": ["analysis", "omni", "vision"]},
    {"id": "platform_amd_capabilities", "name": "AMD Runtime Capabilities", "description": "Inspect available AMD runtime capabilities", "category": "platform", "aliases": ["amd", "rocm", "directml"], "route": "/amd/capabilities", "tags": ["amd", "hardware", "capabilities"]},
    {"id": "wave_k_profanity_wordlists", "name": "Profanity Wordlists", "description": "List profanity wordlists for audio censoring", "category": "audio", "aliases": ["profanity", "censor", "wordlist"], "route": "/audio/censor/profanity/wordlists", "tags": ["audio", "censor", "profanity"]},
    {"id": "wave_qrs_internvl3_info", "name": "InternVL3 Analysis Info", "description": "Inspect the InternVL3 video analysis lane", "category": "analysis", "aliases": ["internvl3", "vision", "wave qrs"], "route": "/analyze/video/internvl3/info", "tags": ["analysis", "vision", "internvl3"]},
    {"id": "integration_adjustment_presets", "name": "Adjustment Layer Presets", "description": "List saved adjustment-layer presets", "category": "editing", "aliases": ["adjustment layer", "presets", "layer preset"], "route": "/api/adjustment-layers/presets", "tags": ["editing", "presets", "layers"]},
    {"id": "color_mam_aces_odts", "name": "ACES Output Transforms", "description": "List available ACES output transforms", "category": "color", "aliases": ["aces", "odt", "color transform"], "route": "/video/aces/odts", "tags": ["color", "aces", "transform"]},
    {"id": "system_auth_info", "name": "Local Auth Info", "description": "Inspect local authentication status", "category": "platform", "aliases": ["auth", "security", "token"], "route": "/auth/info", "tags": ["system", "auth", "security"]},
    {"id": "batch_expression_validate", "name": "Validate Batch Expression", "description": "Validate an expression before batch processing", "category": "editing", "aliases": ["expression", "batch", "validate"], "route": "/expression/validate", "tags": ["batch", "expression", "validation"]},
    {"id": "editing_multilang_sync", "name": "Sync Multilingual Subtitles", "description": "Synchronize a multilingual subtitle project", "category": "captions", "aliases": ["multilingual", "subtitle sync", "translation"], "route": "/multilang/sync", "tags": ["captions", "multilingual", "sync"]},
    {"id": "workflow_edl_export", "name": "Export EDL", "description": "Export an edit decision list for interchange", "category": "export", "aliases": ["edl", "interchange", "timeline export"], "route": "/api/edl/export", "tags": ["export", "edl", "interchange"]},
]
