...
_FEATURES: List[FeatureRecord] = [
    ...
    FeatureRecord(
        ...
        category="audio",
        state=STATE_AVAILABLE,
        install_hint="Unavailable in OpenCut's supported dependency matrix; see Dependency Dashboard.",
    ...
    FeatureRecord(
        ...
        category="captions",
        state=STATE_MISSING_DEPENDENCY,
    ...
    FeatureRecord(
        ...
        routes=["/analyze/video/qwen3vl"],
        probe=_check("check_qwen3vl_available"),
        check_name="check_qwen3vl_available",
        impl_module="multimodal_qwen3vl",
        hardware="cpu/gpu",
        privacy="local-only",
        license="Apache-2.0",
        notes="Frame-sampled local vision scoring with a transcript-first relevance blend.",
    ),
    FeatureRecord(
