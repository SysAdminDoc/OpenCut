...
## 2. Numbers you should trust (live as of 2026-05-25)

| Surface | Count | Source of truth |
|---|---|---|
| API routes | **1,499** | `opencut/_generated/route_manifest.json` (F099) |
| Blueprints | **102** | same |
| Core processing modules (`opencut/core/`) | **592** Python files | `ls opencut/core` |
| Route files (`opencut/routes/`) | **100** (excluding `__init__.py`) | `ls opencut/routes` |
| Tests | **194 test_*.py files** + **2 Vitest panel test files** (≥7,700 tests claimed) | `ls tests/`, `extension/com.opencut.panel/tests/` |
