...
| Blueprints | **107** | same |
| Core processing modules (`opencut/core/`) | **597** Python files | `ls opencut/core` |
| Route files (`opencut/routes/`) | **105** (excluding `__init__.py`) | `ls opencut/routes` |
| Tests | **212 test_*.py files** + **2 Vitest panel test files** (8,400+ tests claimed) | `ls tests/`, `extension/com.opencut.panel/tests/` |
...
DaVinci Resolve ────┤   WebSocket :5680           ├─ routes/* (107 blueprints) ─► core/* (597 modules) ─► FFmpeg / Whisper / Demucs / Torch / ONNX
