...
| Tests | **137 files** (≥7,600 tests claimed) | `ls tests/` |
...
- Pass 11 closed F204 release SBOM attachment for tagged/manual Linux release builds; F219 remains the deeper completeness gate.
