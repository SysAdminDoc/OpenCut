...
- Wired the first-viewport UXP shell, tab bar, processing banner, connection label, workspace overview, and dynamic workspace guide through locale keys. `tests/test_uxp_i18n.py` guards HTML and JS locale coverage, blocks visible-English connection-state checks, and is included in release smoke.
