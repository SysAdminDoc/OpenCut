...
| .NET WPF installer (`installer/src/OpenCut.Installer`) | Targets `net10.0-windows` x64 | `net10.0-windows` supports `RuntimeIdentifier=win-arm64` | Need an ARM64 publish step in CI. |
