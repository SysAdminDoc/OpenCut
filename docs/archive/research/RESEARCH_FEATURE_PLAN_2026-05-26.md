...
- **Current state:** Advanced in `ROADMAP.md` v4.159 to 891 guarded keys across 62 rounds. `i18n-drift` reports 1,305 keys, 1,174 consumers, 131 dead keys, and 0 missing.
...
- [ ] **P2 — E15 i18n migration rolling batches**
  - Status: advanced in ROADMAP v4.159 with an additional 13-key Activity/job-history feedback batch; keep open for the next 5-10 string batch.
