...
- **Current state:** Advanced in `ROADMAP.md` v4.138 to 559 guarded keys across 41 rounds. `i18n-drift` reports 973 keys, 842 consumers, 131 dead keys, and 0 missing.
...
- [ ] **P2 — E15 i18n migration rolling batches**
  - Status: advanced in ROADMAP v4.138 with an additional 25-key settings backend/speech availability batch; keep open for the next 5-10 string batch.
