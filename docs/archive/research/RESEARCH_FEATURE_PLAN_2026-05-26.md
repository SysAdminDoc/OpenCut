...
- **Current state:** Advanced in `ROADMAP.md` v4.152 to 804 guarded keys across 55 rounds. `i18n-drift` reports 1,218 keys, 1,087 consumers, 131 dead keys, and 0 missing.
...
- [ ] **P2 — E15 i18n migration rolling batches**
  - Status: advanced in ROADMAP v4.152 with an additional 10-key Captions chapter/SRT feedback batch; keep open for the next 5-10 string batch.
