...
- **Current state:** Advanced in `ROADMAP.md` v4.178 to 1,083 guarded keys across 80 rounds. `i18n-drift` reports 1,491 keys, 1,365 consumers, 126 dead keys, and 0 missing.
...
- [ ] **P2 — E15 i18n migration rolling batches**
  - Status: advanced in ROADMAP v4.178 with an additional engine grammar batch; keep open for the next high-impact string batch.
