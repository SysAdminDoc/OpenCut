...
- **Current state:** Advanced in `ROADMAP.md` v4.181 to 1,100 guarded keys across 83 rounds. `i18n-drift` reports 1,508 keys, 1,382 consumers, 126 dead keys, and 0 missing.
...
- [ ] **P2 — E15 i18n migration rolling batches**
  - Status: advanced in ROADMAP v4.181 with an additional preview/provider/marker fallback-label batch; keep open for the next high-impact string batch.
