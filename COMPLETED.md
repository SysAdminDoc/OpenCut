...
| Job platform | `@async_job`, SQLite job persistence, explicit local SQLite schema versions, priority workers, cancellation, interrupted-job marking, queue allowlists, structured errors with request IDs in JSON bodies, and log correlation. |
