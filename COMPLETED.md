...
| Area | Completed work |
|---|---|
| Core automation | Silence/filler removal, captions/transcription, caption round-trip sidecars, audio cleanup, video effects, export, timeline actions, deliverables, search, workflow presets, NLP commands, and plugin loading. |
