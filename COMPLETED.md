...
| Job platform | `@async_job`, SQLite job persistence, explicit local SQLite schema versions, priority workers, cancellation, interrupted-job marking, queue allowlists, structured errors, and log correlation. |
