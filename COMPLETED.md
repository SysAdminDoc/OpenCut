...
| Local data stores | Local SQLite schemas use explicit `user_version` migrations, and oversized job-result plus journal inverse/forward JSON payloads spill to content-addressed local files with API-visible metadata. |
