...
| Panel UX | CEP panel, UXP panel, command palette, status surfaces, quick actions, E15 i18n migration through batch 134, keyboard/a11y gates, UXP Agent tab, caption display settings, and panel parity checks. |
