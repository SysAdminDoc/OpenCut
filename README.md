...
OpenCut v1.36.0 includes **1,527 shipped API routes** (implemented or dependency-gated; 27 strategic 501 stubs are tracked separately and excluded), **8 panel tabs** with **50+ sub-tabs**, and covers every major video editing automation task.
