...
OpenCut v1.32.0 includes **1,534 API routes**, **8 panel tabs** with **50+ sub-tabs**, and covers every major video editing automation task.
...
|                       |                    |                       |
|  8 tabs, 50+ sub-tabs |   WebSocket:5680   |  1,534 API routes     |
