...
![Tests](https://img.shields.io/badge/Tests-12000+-brightgreen)
...
12,000+ estimated tests across 301 root test files covering route smoke tests,
...
tests/               # pytest test suite (12,000+ estimated tests, 301 root test files)
