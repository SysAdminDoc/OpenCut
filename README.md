...
9,200+ estimated tests across 232 root test files covering route smoke tests, core module unit tests, feature integration tests, plugin tests, and ExtendScript mock harness.
...
tests/               # pytest test suite (9,200+ estimated tests, 232 root test files)
docs/
