...
![Tests](https://img.shields.io/badge/Tests-13600+-brightgreen)
...
13,600+ estimated tests across 342 root test files covering route smoke tests,
...
tests/               # pytest test suite (13,600+ estimated tests, 342 root test files)
