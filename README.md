...
9,000+ estimated tests across 226 root test files covering route smoke tests, core module unit tests, feature integration tests, plugin tests, and ExtendScript mock harness.
...
tests/               # pytest test suite (9,000+ estimated tests, 226 root test files)
docs/
