...
OpenCut v1.32.0 includes **1,527 API routes**, **8 panel tabs** with **50+ sub-tabs**, and covers every major video editing automation task.
...
|                       |                    |                       |
|  8 tabs, 50+ sub-tabs |   WebSocket:5680   |  1,527 API routes     |
...
9,000+ estimated tests across 225 root test files covering route smoke tests, core module unit tests, feature integration tests, plugin tests, and ExtendScript mock harness.
...
tests/               # pytest test suite (9,000+ estimated tests, 225 root test files)
docs/
