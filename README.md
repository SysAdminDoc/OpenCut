...
![Tests](https://img.shields.io/badge/Tests-13500+-brightgreen)
...
13,500+ estimated tests across 338 root test files covering route smoke tests,
...
tests/               # pytest test suite (13,500+ estimated tests, 338 root test files)
