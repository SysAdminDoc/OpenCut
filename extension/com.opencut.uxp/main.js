...
import { createCutExecutor } from "./uxp-cut-planner.js";
...
const WORKSPACE_META   = {
  cut: {
    ...
    subtitle: "Silence, fillers, and pacing.",
  ...
  captions: {
    ...
    subtitle: "Transcribe, style, and deliver.",
  ...
  audio: {
    ...
    subtitle: "Repair, mix, and master.",
  ...
  video: {
    ...
    subtitle: "Color, reframe, and finish.",
  ...
  timeline: {
    ...
    subtitle: "Markers, cuts, and write-back.",
  ...
  search: {
    ...
    subtitle: "Find footage and run commands.",
  ...
  deliverables: {
    ...
    subtitle: "Reports, documents, and handoff.",
    sourceIds: ["clipPathCut", "clipPathVideo", "clipPathAudio"],
  },
  agent: {
    ...
    subtitle: "Plan and review assisted edits.",
  ...
  settings: {
    ...
    subtitle: "Workspace, engines, and diagnostics.",
    sourceIds: [],
  },
};
...
const PProBridge = (() => {
  ...
  const CutExecutor = createCutExecutor({
    ...
    itemField: _captionItemField,
    timeValueToSeconds: _timeValueToSeconds,
    tickTimeFromSeconds: _tickTimeFromSeconds,
    secondsToTicks: _secondsToTicks,
    projectRoot: _projectRoot,
    sequenceTrackSnapshot: _sequenceTrackSnapshot,
    fingerprintDeltaCount: _fingerprintDeltaCount,
    fingerprintAddedCount: _fingerprintAddedCount,
    verificationStatus: _verificationStatus,
    attachHostWriteVerification: _attachHostWriteVerification,
  });

  /**
   * Applies reviewed cut ranges to the active sequence.
   * @param {Array<{start: number, end: number}>} cuts  — times in seconds
   * @param {"delete"|"disable"} [mode]
   */
  async function applyCuts(cuts, mode = "delete") {
    return await CutExecutor.applyCuts(cuts, mode);
  }
...
const UxpSettingsController = createUxpSettingsController({
  documentRef: document,
  windowRef: window,
...
function bindEvents() {
  UxpSettingsController.initOnboardingEvents();
  // ── Tab navigation ──
...
async function initApp() {
  ...
  UxpSettingsController.initSettingsNavigation();
  await UxpSettingsController.initSettingsIO();
  await UxpSettingsController.initSupportIO();
  bindSliders();
  bindEvents();
  syncQuickActionButtons();
  populateCaptionStyleSelect(UXP_CAPTION_STYLE_FALLBACK, "fallback");
  ...
  if (alive) {
    ...
    await UxpSettingsController.loadOnboarding();
