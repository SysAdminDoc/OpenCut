/* ============================================================
   OpenCut CEP Panel - Main Controller v1.55.1
...
(function () {
    ...
    var OpenCutStringUtils = (typeof window !== "undefined" && window.OpenCutStringUtils) ? window.OpenCutStringUtils : {};
    var humanizeControlId = OpenCutStringUtils.humanizeControlId,
        _journalClipName = OpenCutStringUtils.journalClipName,
        shortsBundleFileName = OpenCutStringUtils.shortsBundleFileName,
        parseTimeToSec = OpenCutStringUtils.parseTimeToSec,
    ...
    el.transcriptSegments = $("transcriptSegments");
        ...
        el.updateRetryBtn = $("updateRetryBtn");
        el.updateOpenBtn = $("updateOpenBtn");
    ...
    function wsStartBridge() {
        api("POST", "/ws/start", {}, function (err, r) {
            ...
            if (r && r.success) {
                ...
                showAlert(t("toast.live_updates_bridge_start_failed", "Failed to start WebSocket bridge"));
            }
        });
    }
    ...
    var _commandIndex = [
        ...
        {name: "Music AI", displayName: function () { return t("palette.tool_music_ai", "Music AI"); }, tab: "audio", sub: "aud-musicai", keywords: "music generate ai musicgen"},
        {name: "Sound Effects", displayName: function () { return t("palette.tool_sound_effects", "Sound Effects"); }, tab: "audio", sub: "aud-sfx", keywords: "sfx sound effect tone"},
        {name: "Audio Ducking", displayName: function () { return t("palette.tool_audio_ducking", "Audio Ducking"); }, tab: "audio", sub: "aud-duck", keywords: "duck ducking lower music dialogue"},
        {name: "Video Effects", displayName: function () { return t("palette.tool_video_effects", "Video Effects"); }, tab: "video", sub: "vid-effects", keywords: "stabilize vignette grain letterbox"},
        {name: "Reframe", displayName: function () { return t("palette.tool_reframe", "Reframe"); }, tab: "video", sub: "vid-reframe", keywords: "reframe resize phone tiktok shorts vertical portrait"},
        {name: "Merge Clips", displayName: function () { return t("palette.tool_merge_clips", "Merge Clips"); }, tab: "video", sub: "vid-merge", keywords: "merge concatenate join combine clips"},
        {name: "Speed / Ramp", displayName: function () { return t("palette.tool_speed_ramp", "Speed / Ramp"); }, tab: "video", sub: "vid-speed", keywords: "speed slow fast ramp reverse"},
        {name: "Compositing & Keying", displayName: function () { return t("palette.tool_compositing_keying", "Compositing & Keying"); }, tab: "video", sub: "vid-chroma", keywords: "chroma green screen key pip blend composite"},
        {name: "Transitions", displayName: function () { return t("palette.tool_transitions", "Transitions"); }, tab: "video", sub: "vid-transition", keywords: "transition fade wipe slide"},
        {name: "Upscale", displayName: function () { return t("palette.tool_upscale", "Upscale"); }, tab: "video", sub: "vid-upscale", keywords: "upscale enhance resolution ai"},
        {name: "Color Correction", displayName: function () { return t("palette.tool_color_correction", "Color Correction"); }, tab: "video", sub: "vid-color", keywords: "color correct grade exposure contrast"},
        {name: "LUTs", displayName: function () { return t("palette.tool_luts", "LUTs"); }, tab: "video", sub: "vid-lut", keywords: "lut color grade cinematic film look"},
        {name: "Face AI", displayName: function () { return t("palette.tool_face_ai", "Face AI"); }, tab: "video", sub: "vid-faceswap", keywords: "face swap enhance gfpgan"},
        {name: "De-Logo / Remove Object", displayName: function () { return t("palette.tool_de_logo_remove_object", "De-Logo / Remove Object"); }, tab: "video", sub: "vid-remove", keywords: "remove watermark object logo delogo inpaint"},
        {name: "Titles", displayName: function () { return t("palette.tool_titles", "Titles"); }, tab: "video", sub: "vid-titles", keywords: "title text overlay lower third"},
        {name: "Export Presets", displayName: function () { return t("palette.tool_export_presets", "Export Presets"); }, tab: "export", sub: "exp-platform", keywords: "export platform youtube tiktok instagram"},
        {name: "Thumbnails", displayName: function () { return t("palette.tool_thumbnails", "Thumbnails"); }, tab: "export", sub: "exp-thumbnail", keywords: "thumbnail extract frame"},
        {name: "Batch Processing", displayName: function () { return t("palette.tool_batch_processing", "Batch Processing"); }, tab: "export", sub: "exp-batch", keywords: "batch process multiple files"},
        { name: "Repeat Detection", displayName: function () { return t("palette.tool_repeat_detection", "Repeat Detection"); }, tab: "captions", sub: "cap-repeat",     keywords: "repeat detect loop fumble duplicate take" },
        { name: "Chapter Generation", displayName: function () { return t("palette.tool_chapter_generation", "Chapter Generation"); }, tab: "captions", sub: "cap-chapters",   keywords: "chapters youtube timestamps sections topics" },
        { name: "Footage Search", displayName: function () { return t("palette.tool_footage_search", "Footage Search"); }, tab: "nlp",      sub: "nlp-search",     keywords: "search footage clips index content find" },
        { name: "Color Match", displayName: function () { return t("palette.tool_color_match", "Color Match"); }, tab: "video",    sub: "vid-color",      keywords: "color match grade balance reference clip" },
        { name: "Multicam Switcher", displayName: function () { return t("palette.tool_multicam_switcher", "Multicam Switcher"); }, tab: "timeline", sub: "tl-multicam",    keywords: "multicam speaker podcast camera switch diarize" },
        { name: "Loudness Match", displayName: function () { return t("palette.tool_loudness_match", "Loudness Match"); }, tab: "audio",    sub: "aud-loudmatch",  keywords: "loudness lufs normalize match audio levels" },
